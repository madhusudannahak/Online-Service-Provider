...
?>
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Add to Service</button></a>
								<?php } else {?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i><img src="brandlogo2.jpeg" height="15" width="15"></i> &nbsp;ADD TO SERVICE</a>
													<?php } else {?>
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Realted Service </h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Add to Service</a>
